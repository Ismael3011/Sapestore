  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 mb-3">
        <h5>Síguenos</h5>
        <ul class="list-unstyled">
          <li><a href="https://www.instagram.com/sapestore_cyv" target="_blank" class="text-white">Instagram: @sapestore_cyv</a></li>
        </ul>
      </div>
    </div>
    <div class="row">
      <div class="col text-center">
        <p class="mb-0">© 2025 Sapestore. Todos los derechos reservados. Propietario: Juanmi Salinas Peña.</p>
      </div>
    </div>
  </div>
</footer>
